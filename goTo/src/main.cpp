 ...
 *
 * Just: "${PATH_TO_BINARY}/goTo --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class goTo : public RoboComp::Application
{
public:
	goTo (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::goTo::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
